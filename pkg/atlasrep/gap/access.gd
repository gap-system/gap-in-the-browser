...
##  file.
##
DeclareGlobalName( "AtlasOfGroupRepresentationsLocalFilename" );
...
##
DeclareGlobalName( "AtlasOfGroupRepresentationsLocalFilenameTransfer" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "AtlasOfGroupRepresentationsAccessFunctionsDefault" );
...
##  </ManSection>
##
DeclareGlobalName( "AtlasStringOfFieldOfMatrixEntries" );
...
##  </ManSection>
##
DeclareGlobalName( "AtlasTableOfContents" );
...
##  <P/>
##  If <C>DataURL</C> is bound then the component <C>MirrorsURL</C>,
##  if bound, must be a list of strings that denote internet addresses
##  from where the same data can be downloaded.
##  <P/>
...
##  <#/GAPDoc>
##
DeclareGlobalName( "StringOfAtlasTableOfContents" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "AtlasOfGroupRepresentationsNotifyData" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "AtlasOfGroupRepresentationsForgetData" );
