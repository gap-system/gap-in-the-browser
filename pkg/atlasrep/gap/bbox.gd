...
##  <#/GAPDoc>
##
DeclareGlobalName( "ScanBBoxProgram" );
...
##
DeclareGlobalName( "BBoxPerformInstruction" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "RunBBoxProgram" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "ResultOfBBoxProgram" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "StraightLineDecision" );

DeclareGlobalName( "StraightLineDecisionNC" );
