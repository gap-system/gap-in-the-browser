...
##  can be omitted here).
##
BindGlobal( "AtlasClassNamesOffsetInfo", rec(
    ordinary:= [
...
##
BindGlobal( "AtlasClassNames", function( tbl )
          ...
          if not IsBound( proxies[i] ) then
            ...
            for j in [ 1 .. Length( orb ) ] do
              ...
              while Fproxies[ imgs[k] ] <> imgs[k] do
                k:= k-1;
#T can be 0, catch this!
#T add tests for this situation!
              od;
              proxies[ orb[j] ]:= orb[k];
...
##
BindGlobal( "AtlasCharacterNames", function( tbl )
...
##
BindGlobal( "StringOfAtlasProgramCycToCcls",
...
#F                                    <bound> )
##
BindGlobal( "AtlasRepComputedKernelGenerators",
...
##
BindGlobal( "CurrentDateTimeString", function( arg )
...
##
BindGlobal( "SendMail", function( sendto, copyto, subject, text )
    local sendmail, inp;
...
##
BindGlobal( "ParseBackwards", function( string, format )
...
##
BindGlobal( "ParseBackwardsWithPrefix", function( string, format )
...
##
BindGlobal( "ParseForwards", function( string, format )
...
##
BindGlobal( "ParseForwardsWithSuffix", function( string, format )
...
##
BindGlobal( "AtlasRepIdentifier", function( arg )
...
##
BindGlobal( "CompositionOfSLDAndSLP",
    function( sld, slp )
