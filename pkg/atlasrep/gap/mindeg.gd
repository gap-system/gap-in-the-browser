...
##
DeclareGlobalName( "MinimalPermutationRepresentationInfo" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "MinimalRepresentationInfo" );
...
##  <#/GAPDoc>
##
DeclareGlobalName( "SetMinimalRepresentationInfo" );
...
##  </ManSection>
##
DeclareGlobalName( "ComputedMinimalRepresentationInfo" );
...
##  </ManSection>
##
DeclareGlobalName( "StringOfMinimalRepresentationInfoData" );
