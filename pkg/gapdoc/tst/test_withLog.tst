...
##  doc/../lib/BibXMLextTools.gi (373-388)
gap> gddirs := DirectoriesPackageLibrary("gapdoc","doc");;
gap> f := Filename(gddirs, "test.bib");;
gap> bib := ParseBibFiles(f);;
...
##  doc/../lib/BibXMLextTools.gi (211-223)
gap> gddirs := DirectoriesPackageLibrary("gapdoc","doc");;
...
##  doc/../lib/BibXMLextTools.gi (978-983)
gap> gddirs := DirectoriesPackageLibrary("gapdoc","doc");;
gap> f := Filename(gddirs, "testbib.xml");;
gap> bib := ParseBibXMLextFiles(f);;
gap> WriteBibXMLextFile("test.xml", bib);

##  doc/../lib/BibXMLextTools.gi (1100-1133)
gap> gddirs := DirectoriesPackageLibrary("gapdoc","doc");;
gap> f := Filename(gddirs, "testbib.xml");;
gap> bib := ParseBibXMLextFiles(f);;
...
##  doc/../lib/BibXMLextTools.gi (1187-1201)
...
##  doc/../lib/BibXMLextTools.gi (1811-1858)   edited for readability 
gap> gddirs := DirectoriesPackageLibrary("gapdoc","doc");;
gap> f := Filename(gddirs, "testbib.xml");;
gap> bib := ParseBibXMLextFiles(f);;
gap> e := bib.entries[1];; strs := bib.strings;;
...
##  doc/../lib/BibXMLextTools.gi (61-110)
gap> TemplateBibXML();
